    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN,reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="JOIN OUR CHANNEL", url="t.me/movies23ez=true".format(bot.username))]]))
    else:
        update.effective_message.reply_text("")
